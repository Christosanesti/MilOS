...
int main(int argc, char *argv[])
{
    ...
    CrashHandler::instance()->initialize("milos-data-guard-gui", "1.0.0");
    CrashHandler::instance()->installCrashHandlers();
    
    // Initialize logger
    Logger::instance()->initialize("milos-data-guard-gui");
    
    // Initialize error handler
    ErrorHandler::instance()->initialize("milos-data-guard-gui");
