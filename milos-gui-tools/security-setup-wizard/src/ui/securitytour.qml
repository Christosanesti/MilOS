...
Rectangle {
    ...
    ColumnLayout {
        ...
        Card {
            ...
            variant: "dashboard"
            title: securityTour.tourSteps[securityTour.currentStep].title
            subtitle: securityTour.tourSteps[securityTour.currentStep].feature
            ...
            ColumnLayout {
                ...
                Text {
                    Layout.fillWidth: true
                    text: securityTour.tourSteps[securityTour.currentStep].description
                    font.pixelSize: 16
                    color: "#cccccc"
                ...
                RowLayout {
                    ...
                    Repeater {
                        model: securityTour.tourSteps.length
                        
                        Rectangle {
                            width: 12
                            height: 12
                            radius: 6
                            color: index === securityTour.currentStep ? "#00d4ff" : "#2a2a2a"
                            border.color: "#00d4ff"
                            border.width: 1
                        }
                    }
        ...
        RowLayout {
            ...
            Button {
                ...
                text: "Back"
                onClicked: {
                    if (securityTour.currentStep > 0) {
                        securityTour.currentStep--
                    } else {
                        securityTour.backClicked()
                    }
                }
            }
            ...
            Button {
                ...
                Layout.preferredHeight: 48
                variant: "primary"
                text: securityTour.currentStep < securityTour.tourSteps.length - 1 ? "Next" : "Continue"
                onClicked: {
                    if (securityTour.currentStep < securityTour.tourSteps.length - 1) {
                        securityTour.currentStep++
                    } else {
                        securityTour.nextClicked()
                    }
                }
            }
        }
