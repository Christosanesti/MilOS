 ...
 * 
 * Parses YAML configuration files for the Data Transmission Guard service.
 */
class ConfigParser {
public:
    ConfigParser();
     ...
     * @param key Configuration key (dot-separated path, e.g., "service.enabled")
...
private:
    ...
    // YAML node storage (using yaml-cpp)
